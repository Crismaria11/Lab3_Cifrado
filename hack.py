...
Este programa es el "atacante" que trata de adivinar el token con un timing attack
"""
...
def find_next_character(base):
    ...
    print(msg % (found_character['median'], found_character['max'],
                 found_character['min'], found_character['stddev']))
    ...
    for top_character in top_characters:
        ...
        print(msg % (top_character['character'], top_character['median'],
                     top_character['max'], top_character['min'], top_character['stddev'], ratio))
